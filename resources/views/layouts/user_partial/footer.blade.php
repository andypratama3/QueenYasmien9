          ...
          <div class="footer-menu">
            ...
            <div class="social-links mt-5">
              <ul class="d-flex list-unstyled gap-2">
                <li>
                  <a href="https://www.facebook.com/meyasmien" target="__blank" class="btn btn-outline-light">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M15.12 5.32H17V2.14A26.11 26.11 0 0 0 14.26 2c-2.72 0-4.58 1.66-4.58 4.7v2.62H6.61v3.56h3.07V22h3.68v-9.12h3.06l.46-3.56h-3.52V7.05c0-1.05.28-1.73 1.76-1.73Z"/></svg>
                  </a>
                </li>
                <li>
                    <a href="https://www.tiktok.com/@queenyasmine9" target="_blank" class="btn btn-outline-light">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M12 2c.6 3.4 2.8 5 6 5v3c-1.2 0-2.3-.2-3.3-.7v5.7a6 6 0 1 1-6-6h.7v3H9a3 3 0 1 0 3 3V2h3Z"/>
                      </svg>
                    </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/meyasmien/" target="_blank" class="btn btn-outline-light">
